      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-normal">Controls</h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-6 bg-transparent p-0 h-auto">
            <TabsTrigger value="dashboard" className="px-4 py-2 rounded-md data-[state=active]:bg-transparent data-[state=active]:text-black">
              Dashboard
            </TabsTrigger>
            <TabsTrigger value="all" className="px-4 py-2 rounded-md data-[state=active]:bg-transparent data-[state=active]:text-black">
              All Controls
            </TabsTrigger>
          </TabsList>
            ...
            <div className="bg-white rounded-lg shadow-sm">
              <div className="p-4 flex items-center gap-4">
                <div className="relative flex-1 max-w-md">
                  ...
                  <Input placeholder="Search by control code, name" className="pl-9" />
                </div>
                <div className="flex items-center gap-2">
                  {['Assignee', 'Framework', 'Entities', 'Domain', 'Function Grouping', 'Control Scope'].map(filter => <Button key={filter} variant="outline" className="text-sm">
              ...
              <Table>
                ...
                <TableBody>
                  {controls.map(control => <TableRow key={control.code}>
                      <TableCell>
                      ...
                      <TableCell>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${control.status === 'Compliant' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
                          {control.status}
                        </span>
                      </TableCell>
