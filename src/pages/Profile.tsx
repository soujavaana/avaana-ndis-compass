    ...
    <Layout>
      ...
      <Tabs defaultValue="business">
        ...
        <TabsContent value="business" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-medium">Contact & Registration Details</CardTitle>
              <p className="text-sm text-gray-500">Personal, business contact information and registration details</p>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Personal Contact */}
              <div>
                <h3 className="font-medium mb-4">Personal Contact Details</h3>
              ...
              {/* Business Contact */}
              <div>
                <h3 className="font-medium mb-4">Business Contact Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
              ...
              <div>
                <h3 className="font-medium mb-4">Business Registration</h3>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        setFormData(prev => ({ ...prev, is_gst_registered: !!checked }))
                      }
                    />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-medium">Service Delivery & Staffing</CardTitle>
              <p className="text-sm text-gray-500">How you provide services and staffing details</p>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="p-3 bg-gray-50 rounded-md flex items-center gap-2">
                  ...
                  <span>{getServiceDeliveryText(formData.business_type)}</span>
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setFormData(prev => ({ ...prev, uses_contractors: !!checked }))
                  }
                />
              ...
              {shareholders.length > 0 ? (
                <div className="space-y-2">
                  {shareholders.map((shareholder) => (
                    <div key={shareholder.id} className="flex items-center justify-between p-3 border rounded-md">
      ...
      <AddShareholderModal
        open={isShareholderModalOpen}
        onOpenChange={setIsShareholderModalOpen}
      />
    </Layout>
  );
};
