...
const BusinessGoals = () => {
  ...
  const events = [
    { date: new Date(2025, 3, 15), title: "Business Plan Review", time: "10:00 AM", status: "scheduled" },
    { date: new Date(2025, 3, 22), title: "Marketing Strategy Session", time: "2:00 PM", status: "scheduled" },
    { date: new Date(2025, 4, 5), title: "Financial Planning", time: "11:00 AM", status: "pending" },
  ];
