    ...
    <Layout>
      <div className="flex flex-col space-y-4 sm:space-y-6 max-w-full">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight">Networking</h1>
            <p className="text-muted-foreground mt-1 text-xs sm:text-sm md:text-base">
              Connect with Support Coordinators and Plan Managers in your area
            </p>
          </div>
          <Network className="h-6 w-6 sm:h-8 sm:w-8 text-avaana-primary" />
        </div>

        <Card className="border-avaana-primary/20">
          <CardHeader className="bg-avaana-primary/5 px-3 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4">
          ...
          <CardContent className="pt-3 pb-3 px-3 sm:pt-4 sm:pb-4 sm:px-4 md:pt-6 md:pb-6 md:px-6">
            <Button variant="default" className="bg-avaana-primary hover:bg-avaana-secondary text-xs sm:text-sm md:text-base">
              Subscribe Now
            </Button>
          </CardContent>
        </Card>
            ...
            <Card key={contact.id} className="hover:shadow-md transition-shadow">
              <CardHeader className="pb-1 sm:pb-2 px-3 md:px-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="bg-avaana-primary/10 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded text-xs font-medium">
                    {contact.distance}
                  </div>
                </div>
              </CardHeader>
