  ...
  return <Layout>
      <div className="container mx-auto py-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          {!showTypeform ? <div className="max-w-md mx-auto">
              ...
              <Form {...registrationForm}>
                <form onSubmit={registrationForm.handleSubmit(handleSignUp)} className="space-y-4">
                  <FormField control={registrationForm.control} name="email" render={({
                field
              }) => <FormItem>
            ...
            </div> : <div className="h-[80vh]">
              {/* Using the Typeform Widget component with lowercase userid (Typeform requirement) */}
              <Widget id="Ym8rFkcS" height={500} hidden={{
            email: userEmail,
            userid: userId || '' // Using lowercase 'userid' as per Typeform's requirement
          }} style={{
            height: "100%"
          }} className="w-full" source="onboarding-demo" transitiveSearchParams={['userid', 'email']} // Updated to use 'userid' instead of 'userId'
          />
            </div>}
        </div>
      </div>
